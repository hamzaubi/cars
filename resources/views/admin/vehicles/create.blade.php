    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ad') ? 'is-invalid' : '' }}" type="number" name="ad" id="ad" value="{{ old('ad', '') }}" step="1">
                @if($errors->has('ad'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_title') ? 'is-invalid' : '' }}" type="text" name="vehicle_title" id="vehicle_title" value="{{ old('vehicle_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('old') ? 'is-invalid' : '' }}" type="number" name="old" id="old" value="{{ old('old', '') }}" step="1">
                @if($errors->has('old'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('authoruid') ? 'is-invalid' : '' }}" type="number" name="authoruid" id="authoruid" value="{{ old('authoruid', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('author_showroom') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="author_showroom" id="author_showroom" value="1" {{ old('author_showroom', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_username') ? 'is-invalid' : '' }}" type="text" name="author_username" id="author_username" value="{{ old('author_username', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_link') ? 'is-invalid' : '' }}" type="text" name="author_link" id="author_link" value="{{ old('author_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('refresh') ? 'is-invalid' : '' }}" type="text" name="refresh" id="refresh" value="{{ old('refresh') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('promote') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="promote" id="promote" value="1" {{ old('promote', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('created') ? 'is-invalid' : '' }}" type="text" name="created" id="created" value="{{ old('created') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine_size') ? 'is-invalid' : '' }}" type="number" name="engine_size" id="engine_size" value="{{ old('engine_size', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('major_accidents') ? 'is-invalid' : '' }}" type="number" name="major_accidents" id="major_accidents" value="{{ old('major_accidents', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minor_accidents') ? 'is-invalid' : '' }}" type="number" name="minor_accidents" id="minor_accidents" value="{{ old('minor_accidents', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_type') ? 'is-invalid' : '' }}" type="text" name="vehicle_type" id="vehicle_type" value="{{ old('vehicle_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trim') ? 'is-invalid' : '' }}" type="text" name="trim" id="trim" value="{{ old('trim', '') }}">
                @if($errors->has('trim'))
